...
// @access Public
exports.getCourses = asyncHandler(async (req: Request, res: any, next: NextFunction) => {
...
// @access Public
exports.getCourse = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
// @access Private
exports.addCourse = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
...
// @access Private
exports.updateCourse = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
...
// @access Private
exports.deleteCourse = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
